pipeline {
    ...
    environment {
        IMAGE_NAME = "aabathorat22/shippingservice:${GIT_COMMIT}"
    }
    ...
    stages {
        ...
        stage('Git Checkout') {
            steps {
                git url: 'https://github.com/aabathorat11/shippingservice.git', branch: 'main'
            }
        }
            ...
            steps {
                withCredentials([usernamePassword(
                    ...
                    sh '''
                        ...
                        git clone https://aabathorat11:${GITHUB_TOKEN}@github.com/aabathorat11/GitOps.git gitops
